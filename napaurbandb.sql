...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-12-2022 a las 09:30:01
...
--
ALTER TABLE `factura_venta`
  MODIFY `id-factura` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `stock`
  MODIFY `id-stock` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
